        ...
        <div className={styles.messagesPageWrapper}>
            <div className={styles.mainTitleWrapper}>
                ...
                {messageDetail === false ?
                    ...
                    />
                    :
                    <p onClick={() => setMessageDetail(false)} className={styles.mainTitleLogOut}>Tüm Mesajlarıma Geri Dön</p>}
            </div>
            {messageDetail === false ?
                <>
                    ...
                    <div onClick={() => setMessageDetail(true)} className={styles.messagesCardsWrapper}>
                        <div className={styles.messagesCardWrapper}>
                            <div className={styles.messageCardLeft}>
                                ...
                                <div className={styles.messageCardLeftTexts}>
                                    <p className={styles.messageCardDesc}><b>Clear Chunky High Heel Boots</b></p>
                                    <p className={styles.messageCardDesc}><b>Satıcı:</b> Flo</p>
                                    <p className={styles.messageCardDesc}><b>Konu:</b> Ürünüm kargoya verildi mi?</p>
                                </div>
                            </div>
                            <div className={styles.messageCardRight}>
                                <p className={styles.messageCardDesc}><b>Cevaplandı</b></p>
                ...
                <div className={styles.messageDetailWrapper}>
                    ...
                    <div className={styles.messageDetailBoxWrapper}>
                        <p className={styles.messageDetailBoxTitle}><b>Önceki Mesajları Görüntüle</b></p>
                        ...
                        <Modal
                            ...
                            trigger={<button className={styles.messageDetailChatBtn}>YENİ SORU SOR</button>}
                        >
                            <>
                                ...
                                <button onClick={() => setOpen(false)} className={styles.messageModalSendBtn}>GÖNDER</button>
                            </>
                        </Modal>
                    </div>
                </div>
