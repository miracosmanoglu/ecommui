...
export default function Register({ accountInfo }) {
    ...
    useEffect(() => {
        ...
        setFullName(`${accountInfo.firstName || ""} ${accountInfo.lastName || ""}` || "")
    ...
    const onUpdate = async (e) => {
        ...
        const userUpdateObject = {
            ...
            mobilePhoneNumber: phone.replace("-", "").replace("-", ""),
            email: mail
        }
        await axios.post(process.env.REACT_APP_CLIENT_API_URL + `/customer/update`, userUpdateObject, {
            headers: {
            ...
            .then(res => {
                ...
                setNotification("Hatalı Giriş, Lütfen Bilgilerinizi Kontrol Ediniz.")
                setTimeout(() => {
                    setNotification(null)
                }, 1000)
            }
    ...
    return (
        <div className={styles.myAccountWrapper}>
            <div className={styles.mainTitleWrapper}>
                ...
                <p onClick={onLogOut} className={styles.mainTitleLogOut}>Çıkış Yap</p>
            </div>
            ...
            <form onSubmit={onUpdate} className={styles.accountForm}>
                ...
                <InputMask className={styles.phoneInput} mask="999-999-9999" value={phone} onChange={(e) => {
                    setPhone(e.target.value)
                }} />
                ...
                />
                <label
                    className={styles.campaingLabel}
                    ...
                    <p className={styles.campaignText}>Kampanya ve duyuruları mail ile almak istiyorum.</p>
                </label>
            ...
            <form className={styles.accountForm}>
                ...
                <div className={styles.accountBtns}>
                    <button
                        type="submit"
                        className={styles.saveBtn}>DEĞİŞTİR</button>
                    <button
                        className={styles.cancelBtn}>İPTAL</button>
                </div>
            </form>
