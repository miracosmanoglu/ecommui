    ...
    return (
        <div className={styles.mySavedCardWrapper}>
            <div className={styles.mainTitleWrapper}>
                ...
                <p onClick={() => setAddCard(true)} className={styles.mainTitleLogOut}>Kredi Kartı Ekle</p>
            </div>
            ...
            {addCard === false ?
                        ...
                        <div className={styles.cardLeft}>
                            {cardTitleChange === false ?
                                <p className={styles.cardTitle}>
                                    MASTERCARD
                                <Image quality={50} onClick={() => setCardTitleChange(true)} src="/editIcon.svg" alt="edit" width="11" height="10" />
                                </p>
                                :
                                <div className={styles.cardTitleChangeWrapper}>
                                    ...
                                    <button
                                        ...
                                        className={styles.minisaveBtn}>KAYDET</button>
                                    <button
                                        onClick={() => setCardTitleChange(false)}
                                        className={styles.minicancelBtn}>Vazgeç</button>
                                </div>}
                            <p className={styles.cardNumber}>123456***********6789</p>
                        </div>
                        <p className={styles.cardRight}>
                            Kartımı Sil
                    </p>
                    </div>
                </>
                ...
                <form className={styles.newCardForm}>
                    ...
                    <div className={styles.cardSecurityNumBox}>
                        ...
                        <p className={styles.cardSecurityNumText}>Kredi kartınızın arka yüzündeki 3 veya 4 haneli CVC2 kodunu giriniz.</p>
                    </div>
                    <label
                        ...
                        <p className={styles.readText}>Kart bilgilerimi sonraki alışverişlerim için altyapınızda saklamak istiyorum. <span>Kullanım şartlarını</span> okudum ve onaylıyorum.</p>
                    </label>
