    ...
    return (
        <div className={styles.sellerProductPageWrapper}>
            ...
            <div className={styles.sellerProductCategoryWrapper}>
                        ...
                        <SwiperSlide>
                            <div className={styles.sellerProductCategorySlide}>
                                <label className={styles.searchLabel}>
                                    ...
                                    <Image quality={50} src="/searchIconMini.svg" alt="arrow" width="9" height="9" />
                                </label>
                                <div className={styles.sellerProductCategoryOptions}>
                                    ...
                                    <p className={styles.sellerProductCategoryOption}>Ev & Mobilya</p>
                                    <p className={styles.sellerProductCategoryOption}>Teknoloji</p>
                                    <p className={styles.sellerProductCategoryOption}>Teknoloji</p>
                                    <p className={styles.sellerProductCategoryOption}>Teknoloji</p>
                                </div>
                            </div>
                ...
                <p className={styles.desc}><b>Seçilen:</b>  Ev & Mobilya {'>'} Ev Tekstili {'>'} Perde  {'>'} </p>
            </div>
            <form className={styles.sellerProductDetailInfosForm}>
                ...
                <div className={styles.SellerProductDetailInfosBtns}>
                    <button
                        ...
                        className={styles.prevBtn}><Image quality={50} src="/prevIcon.svg" alt="timer" width="5" height="9" /><p>GERİ DÖN</p></button>
                    <button
                        onClick={() => { setSection("evrakYukleme") }}
                        className={styles.continueBtn}>DEVAM ET</button>
                </div>
            </form>
        </div>
