...
export default function HomePageGrid({ bannerInfos }) {
    return (
        <div className={styles.gridWrapper}>
            <div className={styles.parent}>
                <div className={styles.div1}>
                    <Image quality={65} layout='fill' alt="homepagegrid1" src={bannerInfos[0].imageUrl} />
                    <p className={styles.divText}>LOREM IPSUM</p>
                </div>
                <div className={styles.div2}>
                    <Image quality={65} layout='fill' alt="homepagegrid1" src={bannerInfos[1].imageUrl} />
                    <p className={styles.divText}>LOREM IPSUM</p>
                </div>
                <div className={styles.div3}>
                    <Image quality={65} layout='fill' alt="homepagegrid1" src={bannerInfos[2].imageUrl} />
                    <p className={styles.divText}>LOREM IPSUM</p>
                </div>
            </div>
            ...
            <div className={styles.parent2}>
                <div className={styles.div4}>
                    <Image quality={65} layout='fill' alt="homepagegrid1" src={bannerInfos[3].imageUrl} />
