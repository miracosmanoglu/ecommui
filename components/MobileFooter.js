            ...
            <div className={styles.footerInnerMobile}>
                ...
                <div className={styles.footerArticlesMobile}>
                    <div className={styles.footerArticlesAccordion}>
                        {accordion ?
                            <h3 onClick={() => setAccordion(!accordion)} className={styles.footerHeadersMobile}>
                                <b>MÜŞTERİ HİZMETLERİ</b>
                                <Image quality={50} src="/arrowdownWhite.svg" alt="arrow" width="9" height="9" />
                            </h3>
                            :
                            <h3 onClick={() => setAccordion(!accordion)} className={styles.footerHeadersMobile}>
                                MÜŞTERİ HİZMETLERİ
                                <Image quality={50} src="/nextIconWhite.svg" alt="arrow" width="5" height="9" />
                            </h3>}
                        <ul className={accordion ? styles.footerListsMobile : styles.accordionInnerClose}>
                            <Link href="/">
                                <a>
                                    <li>
                                        İLETİŞİM
                ...
                <div className={styles.footerArticlesMobile}>
                    <div>
                        {accordion2 ?
                            <h3 onClick={() => setAccordion2(!accordion2)} className={styles.footerHeadersMobile}>
                                <b>HAKKIMIZDA</b>
                                <Image quality={50} src="/arrowdownWhite.svg" alt="arrow" width="9" height="9" />
                            </h3>
                            :
                        ...
                        <ul className={accordion2 ? styles.footerListsMobile : styles.accordionInnerClose}>
                            <Link href="/">
                                <a>
                                    <li>
                                        TARİHÇE
                ...
                <div className={styles.footerArticlesMobile}>
                    <div>
                        {accordion3 ?
                            <h3 onClick={() => setAccordion3(!accordion3)} className={styles.footerHeadersMobile}>
                                <b>ÜRÜNLER</b>
                                <Image quality={50} src="/arrowdownWhite.svg" alt="arrow" width="9" height="9" />
                            </h3>
                            :
                        ...
                        <ul className={accordion3 ? styles.footerListsMobile : styles.accordionInnerClose}>
                            <Link href="/">
                                <a>
                                    <li>
                                        EL YAPIMI
