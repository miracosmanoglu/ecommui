        ...
        <div className={styles.orderPageWrapper}>
            <div className={styles.mainTitleWrapper}>
                ...
                {orderDetail === false ?
                    ...
                    />
                    :
                    <p onClick={() => setOrderDetail(false)} className={styles.mainTitleLogOut}>Tüm Siparişlerime Geri Dön</p>}
            </div>

            {orderDetail === false ?
                <>
                    <p className={styles.orderCountText}>Toplam 4 adet sipariş</p>
                    <div className={styles.orderWrapper} onClick={() => setOrderDetail(true)}>
                        ...
                        <div className={styles.orderRight}>
                            <p>Toplam: <b>250,98 TL</b></p>
                            <Image quality={50} src="/nextIcon.svg" alt="next" width="5" height="8.5" />
                        </div>
                    </div>
                </>
                :
                ...
                <div className={styles.orderDetailWrapper}>
                    <p className={styles.subTitle}>
                        <Image quality={50} src="/infoIcon.svg" alt="next" width="20" height="20" />
                    Kargo firmalarının çalışma yoğunluğuna bağlı olarak, alışverişlerinizin teslimat süreleri değişkenlik gösterebilir. Anlayışınız için teşekkür ederiz.
                    </p>
                    <div className={styles.orderDetailCard}>
                        <p className={styles.orderDetailDateInfo}>03.10.2020 tarihinde kargoya verilen siparişleriniz</p>
                        <div className={styles.orderDetailCardLeft}>
                            <p className={styles.orderDetailStatus}>Sipariş Durumu:  <span>Teslim Edildi</span></p>
                            <p className={styles.orderDetailCompany}>Kargo Firması:  <b>Aras Kargo</b></p>
                        ...
                        <div className={styles.orderDetailCardRight}>
                            <button className={styles.orderDetailButton}>TESLİMAT BİLGİLERİ</button>
                    ...
                    <div className={styles.orderSummaryWrappper}>
                        ...
                        <div className={styles.orderSummaryBottom}>
                            <div className={styles.orderSummaryTexts}>
                                <b>Ödeme Bilgileri</b>
                                <p >
                                    <Image quality={50} className={styles.orderSummaryCardImg} src="/orderCard.svg" alt="mastercard" width="20" height="15" />
                                    ****8674 / Tek Çekim
                                </p>
                            </div>
                            <div className={styles.orderSummaryTexts}>
                            ...
                            <div className={styles.orderSummaryTexts}>
                                <b>Sipariş Özeti</b>
                                <p>Toplam Sipariş Tutarı:<b>279,98 TL</b></p>
                                <p>Gönderim Ücreti:<b>8,99 TL</b></p>
                                <p>Sipariş İndirimi:<b>37,99 TL</b></p>
                                <p>Toplam:<b>250,98 TL</b></p>
                            </div>
                        </div>
                    </div>
