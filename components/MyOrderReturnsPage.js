                    ...
                    <div className={styles.orderReturnCardLeft}>
                        ...
                        <div className={styles.orderReturnInfo}>
                            ...
                            <div className={styles.orderReturnText}>
                                ...
                                <p>1 Adet / Krem / 37</p>
                                <p><b>Satıcı:</b> Flo</p>
                                <p><b>İade Nedeni:</b> Ürünü iade etmek istiyorum.</p>
                            </div>
                        </div>
                    </div>
                    <div className={styles.orderReturnCardRight}>
                        <p className={styles.orderReturnPrice}>Fiyat: <b>89,99 TL</b></p>
                        <Modal
                            closeIcon
                            onClose={() => {
                                setOpen(false)
                            ...
                            onOpen={() => setOpen(true)}
                            open={open}
                            trigger={<button className={styles.orderReturnButton}>ÜRÜNÜ DEĞERLENDİR</button>}
                        >
                            <>
                                <div className={styles.orderRatingInfoWrapper}>
                                    ...
                                    <div className={styles.orderRatingInfoTexts}>
                                        <p className={styles.orderRatingTitle}>Clear Chunky High Heel Boots</p>
                                        <p className={styles.orderRatingContent}>Ürünün içeriği</p>
                                    </div>
                                </div>
                                <p className={styles.orderRatingStarText}>Değerlendir</p>
                                <Rating className={styles.orderRatingStars} maxRating={5} clearable />
                                ...
                                <p className={styles.orderRatingCriterion}>Yorum Yayınlanma Kriterleri <Image onClick={() => setOrderDetail(true)} src="/nextIcon.svg" alt="next" width="5" height="8.5"  quality={50} /></p>
                                <label
                                ...
                                <label
                                    ...
                                    <p className={styles.readText}>Yorum eklemek için <b>kullanıcı sözleşmesini</b> kabul ediyorum.</p>
                                </label>
                                <button onClick={() => setOpen(false)} className={styles.orderRatingBtn}>YORUM YAP</button>
                            </>
                        </Modal>
                    </div>
                </div>
