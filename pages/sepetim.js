            ...
            {onCont === 1 ?
                <main className={styles.shipMainContainer}>
                    <div className={styles.shipHeader}>
                        <h3>Alışveriş Sepetim</h3><span>2 Ürün</span>
                    </div>
                    <div className={styles.shipCenter}>
                        <div className={styles.shipProducts}>
                            ...
                            <div className={styles.shipProduct}>
                                <div className={styles.shipProductImgCon}>
                                    <div className={styles.shipProductImage}>
                                        <Image
                                            quality={50}
                                            layout='fill'
                                            src="https://i.hizliresim.com/4w4Tyd.png"
                                    ...
                                    <div className={styles.shipProductDescrip}>
                                        ...
                                        <p>1 Adet / Krem / 37</p>
                                        <h6>Satıcı: <span style={{ fontWeight: 'normal' }}>Beyorganik</span></h6>
                                    </div>
                                </div>
                                ...
                                <div className={styles.counterDrop}>
                                    <Dropdown defaultValue={1} className="basketCountDrop" options={options} selection />
                                </div>
                        ...
                        <div className={styles.shipPayment}>
                            <div className={styles.shipPaymentRCard}>
                                ...
                                <p>Kargo ücreti ödememeniz için sepetinizdeki tüm ürünlerin kargo ücretsiz olması gerekmektedir.</p>
                                <div className={`${styles.shipPaymentRCardInfos} ${styles.shipPaymentRCardInfosBB}`}>
                                    <span>İndirim</span>
                                    <span>60,16 TL</span>
                                </div>
                                <div className={styles.shipPaymentRCardInfos}>
                            ...
                            <button onClick={() => setOpenDiscCode(!openDiscCode)} className={styles.shipPromotionCodeBtn}>İndirim Kodu <span>{openDiscCode ? '-' : '+'}</span></button>
                            {openDiscCode ?
                                ...
                                : null}
                            <button onClick={() => setOnCont(2)} className={styles.shipGoPaymentBtn}>DEVAM</button>
                        </div>
                    </div>
                    <div>
                            ...
                            >
                                <SwiperSlide>
                                    <div className={styles.productContainerCC}>
                                        ...
                                        <button className={styles.addBasketBtnCC}>SEPETE EKLE</button>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className={styles.productContainerCC}>
                ...
                <main className={styles.shipMainContainer2}>
                    <div>
                        <div className={styles.payAccordion}>
                            <h6 onClick={() => setOpenAccordion(!openAccordion)}>1. Teslimat<span className={styles.payAccordionSpan}><strong className={styles.shipSteps}>Adım 1/3</strong>  {openAccordion ? '-' : '+'}</span></h6>
                            <div className={openAccordion ? styles.payAccordionInner : styles.payAccordionInnerClose}>
                                <div className={styles.addressWrapper}>
                                    <p className={styles.addressTitle}>Adrese Teslimat</p>
                                    <div className={styles.addressBox}>
                                        <div className={styles.addressTopButtons}>
                                            <p>Ev Adresim:</p>
                                            <button className={styles.addressDeleteButton}>Değiştir/Diğer Adresler</button>
                                        </div>
                                ...
                                <button onClick={() => setOpenAdressForm(true)} className={styles.addNewAdresFormOpen}>Yeni Adres Ekle</button>
                                {openAdressForm ? <form className={styles.addressForm}>
                        ...
                        <div className={styles.payAccordion}>
                            <h6 onClick={() => setOpenAccordion2(!openAccordion2)}>2. Ödeme<span className={styles.payAccordionSpan}><strong className={styles.shipSteps}>Adım 2/3</strong>  {openAccordion2 ? '-' : '+'}</span></h6>
                            <div className={openAccordion2 ? styles.payAccordionInner : styles.payAccordionInnerClose}>
                                <div className={styles.addressWrapper}>
                                    ...
                                    <label
                                        ...
                                        <p className={styles.readText}>Fatura adresim, gönderi adresim ile aynı</p>
                                    </label>
                                </div>
                                <form className={styles.newCardForm}>
                                    ...
                                    <div className={styles.payTypes}>
                                        <label className={styles.payType}>
                                            <Checkbox
                                                ...
                                                name="payType"
                                                className="addressRadio" />
                                            <p className={styles.addressTypeText}>Banka Kartı / Kredi Kartı</p></label>
                                        <label className={styles.payType}>
                                            <Checkbox
                                                onChange={handleChange}
                                                value='kurumsal'
                                                ...
                                                name="payType"
                                                className="addressRadio" />
                                            <p className={styles.addressTypeText}>Kapıda Ödeme</p></label>
                                    </div>
                                    ...
                                    <div className={styles.cardNumandCVV}>
                                        ...
                                        <div className={styles.cardCVV}>
                                            <div className={styles.descPay}>CVV<Image quality={50} src="/infoIcon2.svg" alt="edit" width="12" height="12" /></div>
                                            <input
                                                type="number"
                                    ...
                                    <label
                                        ...
                                        <p className={styles.readText}><strong>Kullanım şartlarını</strong> okudum ve onaylıyorum.</p>
                                    </label>
                                </form>

                                <div className={styles.contractsWrapper}>
                                    <div className={styles.contractWrapper}>
                                        <p className={styles.contractTitle}>SİPARİŞ-SÖZLEŞME ÖN BİLGİLENDİRMELERİ</p>
                                        <p className={styles.contractDesc}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.
                                    ...
                                    <div className={styles.contractWrapper}>
                                        <p className={styles.contractTitle}>SİPARİŞ-SÖZLEŞME DİĞER ÖN BİLGİLENDİRMELERİ</p>
                                        <p className={styles.contractDesc}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.
                                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet</p>
                                    </div>
                                    <div className={styles.contractWrapper}>
                                        <p className={styles.contractTitle}>MESAFELİ SATIŞ SÖZLEŞMESİ</p>
                                        <p className={styles.contractDesc}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.
                                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet</p>
                                    </div>
                                </div>
                        ...
                        <div className={styles.payAccordion}>
                            <h6 onClick={() => setOpenAccordion3(!openAccordion3)}>3. Siparişi İncele<span className={styles.payAccordionSpan}><strong className={styles.shipSteps}>Adım 3/3</strong>  {openAccordion3 ? '-' : '+'}</span></h6>
                            <div className={openAccordion3 ? styles.payAccordionInner : styles.payAccordionInnerClose}>
                                ...
                                <div className={styles.lastStepShipProduct}>
                                    <div className={styles.shipProductImgCon}>
                                        ...
                                        <div className={styles.lastStepDescrip}>
                                            ...
                                            <h5>Pilavlık Bulgur Köy Tipi</h5>
                                            <p>1 Adet / Krem / 37</p>
                                            <strong>Satıcı: <span style={{ fontWeight: 'normal' }}>Beyorganik</span></strong>
                                        </div>
                                    </div>
                                ...
                                <p className={styles.lastStepBottomPolicy}>Siparişiniz teslim edilirken mutlaka kargo görevlisinin yanında paketi açıp kontrol ediniz. Ürünün kusurlu olduğunu düşündüğünüz durumlarda teslim almayıp, kargo görevlisinden tutanak tutmasını isteyiniz. Kusursuz yeni ürün en kısa süre içerisinde adresinize ulaştırılacaktır. Bu adımları takip etmeyerek ürünü teslim almanız durumunda sorumluluk … ya ait olmayacaktır.<b>Mesafeli satış sözleşmesine ulaşmak için tıklayınız.</b></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className={styles.shipPayment}>
                            <div className={`${styles.shipPaymentRCard} ${styles.shipPaymentRCardTop}`}>
                                <strong>Sepet Özeti</strong>
                                <div className={`${styles.shipProduct} ${styles.shipProduct2B}`}>
                                    <div className={styles.shipProductImgCon}>
                                        ...
                                        <div className={`${styles.shipProductDescrip} ${styles.shipProductDescrip2B}`}>
                                            <div>
                                                <h4>Beyorganik</h4>
                                                <h5>Pilavlık Bulgur Köy Tipi</h5>
                                                <span>1 Adet</span>
                        ...
                        <div className={styles.shipPayment}>
                            ...
                            <Modal
                                ...
                                <div className={styles.paymentModalContainer}>
                                    <h1>LOGO</h1>
                                    <p>Aşağıdaki <b>"onayla ve bitir"</b> butonuna basarak,
                                    <b>"Kredi Kartı Kayıt Sözleşmesi"</b>ni kabul ediyorum.
                                    </p>
                                    <strong>Kredi Kartı Kayıt Sözleşmesi <span>{'>'}</span></strong>
                                    <button>ONAYLA VE BİTİR</button>
                                </div>
                            </Modal>
                            <button style={{ backgroundColor: '#333333' }} onClick={() => setOnCont(1)} className={styles.shipGoPaymentBtn}>GERİ DÖN</button>
                        </div>
                    </div>
                </main>
            }
