        ...
        <Layout>
            ...
            <>
                <ul className={styles.sellerApplicationNavbar}>
                    <li
                        className={section === "firmaBilgileri" ? styles.activeSection : null}
                        onClick={() => setSection("firmaBilgileri")}>Firma Bilgileri</li>
                    <li
                        className={section === "urunDetayBilgileri" ? styles.activeSection : null}
                        onClick={() => setSection("urunDetayBilgileri")}>Ürün Detay Bilgileri</li>
                    <li
                    ...
                    <li
                        ...
                        onClick={() => setSection("urunOzeti")}>Ürün Özeti</li>
                </ul>
