...
import { Breadcrumb, Dropdown, DropdownItem, Modal, Search } from 'semantic-ui-react'
            ...
            <main className={styles.productCommentMainContainer}>
                <div className={styles.productCommentProd}>
                    ...
                    <div className={styles.productCommentProdRight}>
                        <button className={styles.addBasketSldBtnCmtDetail}>SEPETE EKLE</button>
                ...
                <div className={styles.commentFilter}>
                    <Dropdown defaultValue={1} className="commentSortDrop" options={options} selection />
                    <input className={styles.commentFilterInput} placeholder='Yorumlarda Ara...'></input>
                    <Dropdown placeholder='Filtrele' className="commentSortDropStar" options={optionsStar} selection />
                </div>
                <div className={styles.allCommentsContainerDet}>
                    {comments.map((e, index) => (
                        <div key={index} className={styles.commentCD}>
                            ...
                            <p className={styles.commentTextCD}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt  ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
                            <Modal
                            ...
                            >
                                <div className={styles.reportCommentContainer}>
                                    ...
                                    <div className={styles.reportCommentContainerBtns}>
                                        <button onClick={() => setModalOpenTwo(false)} className={styles.reportCommentContainerBtn1}>Vazgeç</button>
                                        <Modal
                                            ...
                                            className='commentRepModal'
                                            trigger={
                                                <button className={styles.reportCommentContainerBtn2}>Şikayet Et</button>
                                            }
                                        >
                                            <div className={styles.reportCommentContainerDone}>
                                                ...
                                                }} className={styles.reportCommentContainerSub}>Tamam</button>
                                            </div>
                                        </Modal>
                                    </div>
                                </div>
                    ...
                    <div onClick={() => { window.scrollTo(0, 0) }} className={styles.goTopBtnCommentCD}>
